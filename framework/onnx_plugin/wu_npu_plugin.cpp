...
namespace domi {
    Status ParseParamsWuRelu(const Message *op_src, ge::Operator& op_dst)
    {
    ...
    REGISTER_CUSTOM_OP("WuReluNpu")
    .FrameworkType(ONNX)
    .OriginOpType("ai.onnx::11::WuReluNpu")
    .ParseParamsFn(ParseParamsWuRelu)
