...
ut_case = BroadcastOpUT(op_type ="wu_relu_npu" , op_module_name = "impl.wu_relu_npu", op_func_name = "wu_relu_demo")
...
def np_wu_relu_npu(x, y, negative_slope):
    """input tensor(dict) : x
...
ut_case.add_precision_case(support_soc=["Ascend610", "Ascend310"], case={
    ...
    "case_name": "test_wu_relu_npu_precision",
    "calc_expect_func": np_wu_relu_npu,
})