...
def generate_model(input_shape, alpha, output_shape, model_save_path):
    ...
    model_def = onnx.helper.make_model(graph_def,
                                       producer_name='wu_relu_npu')
    model_def.opset_import[0].version = 11
    onnx.save(model_def, model_save_path)

def comupte_wu_relu_npu(input_shape, alpha, input_data_path, gt_save_path):
...
if __name__ == "__main__":
    ...
    model_save_path = "./model/wurelu_{}_{}_{}_{}.onnx".format(*input_shape)
    input_data_path = "./input_data/wurelu_in_{}_{}_{}_{}.bin".format(*input_shape)
    gt_save_path = "./ground_truth/wurelu_gt_{}_{}_{}_{}.bin".format(*output_shape)

    generate_model(input_shape, alpha, output_shape, model_save_path)
    input_data, expect_data = comupte_wu_relu_npu(input_shape, alpha, input_data_path, gt_save_path)
